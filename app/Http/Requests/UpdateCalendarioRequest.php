...
class UpdateCalendarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'descripcion_calendario' => 'sometimes|required|string|max:255',
            'observaciones_calendario' => 'sometimes|nullable|string|max:255',
            'id_estado_calendario_fk' => 'sometimes|required|integer|exists:tbl_estado_calendario,id_estado_calendario_pk',
            'id_agencias_fk' => 'sometimes|required|integer|exists:tbl_agencias,id_agencias_pk',
            'id_orden_servicio_fk' => 'sometimes|required|integer|exists:tbl_orden_servicio,id_orden_servicio_pk',
            'id_tipo_mantenimiento_fk' => 'sometimes|required|integer|exists:tbl_tipo_mantenimiento,id_tipo_mantenimiento_pk',
