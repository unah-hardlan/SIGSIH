...
class UpdateProyectoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fecha_inicio_proyecto' => 'sometimes|required|date|date_format:Y-m-d',
            'fecha_estimada_fin_proyecto' => 'sometimes|nullable|date|date_format:Y-m-d|after_or_equal:fecha_inicio_proyecto',
            'fecha_finalizacion_proyecto' => 'sometimes|nullable|date|date_format:Y-m-d|after_or_equal:fecha_inicio_proyecto',
