                ...
                fetch('/api/login', {
                    ...
                    .then(data => {
                        if (data.token) {
                            ...
                            if (window.showToast) {
                                showToast('Bienvenido', 'success', { duration: 1800 });
                                setTimeout(() => window.location.replace('/admin/dashboard'), 700);
                            } else {
                    ...
                    .catch(error => {
                        ...
                        if (window.showToast) {
                            showToast(error.message || 'Ocurrió un error al intentar iniciar sesión.', 'error');
                        } else {
