...
<div class="flex flex-col items-center justify-center py-16 text-center space-y-6">
    <div
        class="flex items-center justify-center w-24 h-24 rounded-full bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-200 shadow-inner text-3xl font-semibold">
        {{ $code }}
    </div>
