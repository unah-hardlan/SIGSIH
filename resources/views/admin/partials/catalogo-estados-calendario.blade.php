...
"
    ...
    <x-responsive-table class="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4">
        ...
        <x-slot name="actions">
            ...
            @else
            <button disabled title="No tiene permiso para crear Estados del Calendario"
                        ...
                        <template x-for="(estadoCalendario, index) in paginatedEstadosCalendario()" :key="estadoCalendario.id_estado_calendario_pk">
                            <tr class="border-b border-gray-200 dark:border-gray-700 nunito-regular"
                                ...
                                <td class="py-2 px-4 flex gap-2" :class="{ 'last:rounded-br-lg': index === paginatedEstadosCalendario().length - 1 }">
                                    ...
                                    @else
                                    <span class="text-blue-300 cursor-not-allowed" title="No tiene permiso para editar Estados del Calendario"><i class="fas fa-edit"></i></span>
                                    @endperm
                                    ...
                                    @else
                                    <span class="text-red-300 cursor-not-allowed" title="No tiene permiso para eliminar Estados del Calendario"><i class="fas fa-trash"></i></span>
                                    @endperm
                                </td>
                            </tr>
                        </template>
                ...
                <template x-for="estadoCalendario in paginatedEstadosCalendario()" :key="estadoCalendario.id_estado_calendario_pk">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-black dark:border-black p-4 space-y-2">
                        ...
                        <div class="flex justify-end gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                            ...
                            @else
                            <button disabled title="No tiene permiso para editar Estados del Calendario" class="px-3 py-1 text-xs bg-blue-600 text-white rounded opacity-50 cursor-not-allowed flex items-center gap-1 nunito-regular">
                                <i class="fas fa-edit"></i> Editar
                            </button>
                            @endperm
                            @perm(['Catálogo','Estados del Calendario','Estado del Calendario'], 'eliminacion')
                            ...
                            @else
                            <button disabled title="No tiene permiso para eliminar Estados del Calendario" class="px-3 py-1 text-xs bg-red-600 text-white rounded opacity-50 cursor-not-allowed flex items-center gap-1 nunito-regular">
                                <i class="fas fa-trash"></i> Eliminar
                            </button>
                            @endperm
                        </div>
