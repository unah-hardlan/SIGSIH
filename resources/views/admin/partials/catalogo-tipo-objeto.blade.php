                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-black dark:border-gray-800 p-4">
                            ...
                            <div class="space-y-1 text-sm">
                                <div><span class="font-medium text-gray-600 dark:text-gray-300 nunito-bold">Descripción:</span>
                                    <span class="text-gray-900 dark:text-gray-200 nunito-regular" x-text="tipo.descripcion"></span>
                                </div>
                                <div><span class="font-medium text-gray-600 dark:text-gray-300 nunito-bold">Creado por:</span>
                                    <span class="text-gray-900 dark:text-gray-200 nunito-regular" x-text="tipo.creado_por"></span>
                                </div>
                                <div><span class="font-medium text-gray-600 dark:text-gray-300 nunito-bold">Fecha creación:</span>
                                    <span class="text-gray-900 dark:text-gray-200 nunito-regular" x-text="new Date(tipo.fecha_creacion).toLocaleDateString()"></span>
                                </div>
                                <template x-if="tipo.modificado_por">
                                    <div><span class="font-medium text-gray-600 dark:text-gray-300 nunito-bold">Modificado por:</span>
                                        <span class="text-gray-900 dark:text-gray-200 nunito-regular" x-text="tipo.modificado_por"></span>
                                    </div>
                                </template>
                                <template x-if="tipo.fecha_modificacion">
                                    <div><span class="font-medium text-gray-600 dark:text-gray-300 nunito-bold">Fecha modificación:</span>
                                        <span class="text-gray-900 dark:text-gray-200 nunito-regular" x-text="new Date(tipo.fecha_modificacion).toLocaleDateString()"></span>
                                    </div>
                                </template>
                            </div>
