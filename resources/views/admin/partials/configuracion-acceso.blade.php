...
<div class="flex border-b mb-6 flex-wrap gap-2 border-gray-200 dark:border-gray-700">
    ...
    <div x-show="tab === 'gestion'" x-data="{ ready: false }" x-init="$store.access.init(); ready = true;">
        <x-admin.tabla-crud class="nunito-bold" :titulo="'Gestión de Permisos'">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-5 text-gray-900 dark:text-gray-200">
                <!-- Roles -->
                <div class="md:col-span-1 bg-white dark:bg-gray-800 rounded-2xl shadow-lg ring-1 ring-gray-200 dark:ring-gray-700 p-4" x-data="{ roleQ: '' }">
                    ...
                    <ul class="space-y-1 max-h-[420px] overflow-auto pr-1 custom-scrollbar">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                                    ...
                                                    <button type="button" @click.prevent="$store.access.toggleModulo(g.id, !$store.access.moduloTieneAcceso(g.id))"
                                                        class="h-6 w-10 rounded-full border transition relative bg-white dark:bg-gray-700"
                                                        :class="$store.access.moduloTieneAcceso(g.id) ? 'bg-blue-600 border-blue-600' : 'border-gray-300 dark:border-gray-600'"
                                                        :aria-pressed="$store.access.moduloTieneAcceso(g.id) ? 'true' : 'false'">
                                                        <span class="absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-white dark:bg-gray-200 shadow transform transition"
