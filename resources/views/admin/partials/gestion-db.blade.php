...
<div class="max-w-4xl mx-auto py-8 dark:bg-gray-900 min-h-screen" x-data="{
    ...
    <div class="flex border-b dark:border-gray-700 mb-4 space-x-4 text-base">
        ...
        <div x-show="tab === 'respaldo'" class="space-y-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-2 nunito-bold">Respaldar base de datos</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Servidor</label>
                    <input type="text" value="(local)" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                </div>
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Base de Datos</label>
                    <input type="text" value="SIGSIH" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                </div>
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Usuario</label>
                    <input type="text" value="sa" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                </div>
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Contraseña</label>
                    <input type="password" value="123456" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                </div>
                <div class="md:col-span-2">
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Guardar respaldo en:</label>
                    <input type="text" value="C:\backups\SIGSIH.bak" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                </div>
            </div>
        ...
        <div x-show="tab === 'restore'" class="space-y-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-2 nunito-bold">Restaurar base de datos</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Servidor Local</label>
                    <input type="text" value="(local)" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                </div>
                <div>
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Base de Datos</label>
                ...
                <div class="md:col-span-2">
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300 nunito-bold">Seleccionar archivo .bak</label>
                    <div class="flex gap-2">
                        <input type="text" value="C:\backups\SIGSIH.bak" class="w-full border rounded px-3 py-2 nunito-regular dark:bg-gray-900 dark:text-white dark:border-gray-700" />
                        <button class="transitions duration-200 ease-in-out bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 px-4 py-2 rounded nunito-regular text-gray-800 dark:text-white">Examinar</button>
                    </div>
                </div>
            </div>
