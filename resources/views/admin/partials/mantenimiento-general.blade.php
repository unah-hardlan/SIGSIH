<div class="container mx-auto py-8 dark:bg-gray-900 min-h-screen" x-data="settingsState()" x-init="init()">
    ...
    <div x-show="tab === 'parametros' && isLoadingSettings" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6" x-cloak>
        <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 nunito-regular">
            <svg class="animate-spin h-4 w-4 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path>
            </svg>
            Cargando parámetros desde base de datos...
        </div>
    </div>
