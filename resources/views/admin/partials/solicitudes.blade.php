                    ...
                    <tbody>
                        ...
                        <template x-for="sol in filteredSolicitudes()" :key="sol.id">
                            <tr
                                ...
                                <td class="py-2 px-4 text-gray-900 dark:text-gray-200 nunito-regular"
                                    x-text="sol.numero_solicitud_acf || '—'"></td>
                                <td class="py-2 px-4 text-gray-900 dark:text-gray-200 nunito-regular"
                                ...
                                <td class="py-2 px-4 flex gap-2">
                                    <a href="#" @click.prevent="openEditSolicitud(sol)"
                                        class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
                                    <a href="#" @click.prevent="openDeleteSolicitud(sol)"
                    ...
                    <tbody>
                        ...
                        <template x-for="c in filteredContactos()" :key="c.id">
                            <tr
                                class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 nunito-regular">
                                <td class="py-2 px-4 text-gray-900 dark:text-gray-200 nunito-regular"
                                    x-text="c.tipo_contacto"></td>
                                <td class="py-2 px-4 text-gray-900 dark:text-gray-200 nunito-regular"
                                    x-text="c.valor_contacto"></td>
                                <td class="py-2 px-4 text-gray-900 dark:text-gray-200 nunito-regular"
                                    x-text="clienteLabelById(c.id_cliente_fk) || '—'"></td>
                                <td class="py-2 px-4 flex gap-2">
                                    <a href="#" @click.prevent="openEditContacto(c)"
                                        class="text-blue-500 hover:text-blue-700"><i class="fas fa-edit"></i></a>
                                    <a href="#" @click.prevent="openDeleteContacto(c)"
                                        class="text-red-500 hover:text-red-700"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        </template>
