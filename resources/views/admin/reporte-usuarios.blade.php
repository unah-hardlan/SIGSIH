                ...
                <table class="min-w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-300 py-2 px-3 nunito-regular">{{ $u->nombre }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="border border-gray-300 py-4 px-3 text-center text-gray-500">Sin datos</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
