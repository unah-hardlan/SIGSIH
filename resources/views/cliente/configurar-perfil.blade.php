...
@section('title', 'Configurar Perfil - Hardlan')
@section('content')
        ...
        <div class="p-6">
            <form action="{{ route('cliente.configurar-perfil.store') }}" method="POST" id="profile-form" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="text-center mb-6">
                    <h3 class="text-base font-bold text-white mb-3 font-nunito">Foto de Perfil</h3>
                    <div class="flex flex-col items-center">
                        ...
                        <div id="avatar-drop-zone" class="w-full max-w-xs border-2 border-dashed border-gray-600 rounded-lg p-4 text-center cursor-pointer hover:border-blue-400 hover:bg-blue-900/10 transition-all duration-300 ease-in-out">
                            ...
                            <label for="avatar" class="cursor-pointer">
                                ...
                                <p class="text-xs text-gray-400 font-nunito">
                                    <span class="font-medium text-blue-400">Clic para subir</span> o arrastra
                                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="space-y-1">
                        <label for="primer_nombre" class="block text-base font-bold text-gray-300 font-nunito">
                        ...
                        <input 
                            ...
                            required 
                            data-validate="name"
                            class="w-full px-3 py-2 border-2 border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors duration-200 text-sm font-nunito"
                            placeholder="Ej. John"
                    ...
                    <div class="space-y-1">
                        <label for="segundo_nombre" class="block text-base font-bold text-gray-300 font-nunito">
                            Segundo Nombre
                        </label>
                        <input 
                            id="segundo_nombre" 
                    ...
                    <div class="space-y-1">
                        <label for="primer_apellido" class="block text-base font-bold text-gray-300 font-nunito">
                        ...
                        <input 
                            ...
                            required 
                            data-validate="name"
                            class="w-full px-3 py-2 border-2 border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors duration-200 font-nunito text-sm"
                    ...
                    <div class="space-y-1">
                        <label for="segundo_apellido" class="block text-base font-bold text-gray-300 font-nunito">
                            Segundo Apellido
                        </label>
                        <input 
                            id="segundo_apellido" 
                    ...
                    <div class="space-y-1">
                        <label for="dni" class="block text-base font-bold text-gray-300 font-nunito">
                    ...
                    <div class="space-y-1">
                        <label for="id_genero_fk" class="block text-base font-bold text-gray-300 font-nunito">
                        ...
                        <select 
                            ...
                            class="w-full px-3 py-2 border-2 border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:border-blue-400 transition-colors duration-200 font-nunito text-sm"
                        >
                ...
                <div class="space-y-4">
                    <h3 class="text-lg font-bold text-white font-nunito">
                        Email de Contacto
                    </h3>
                            ...
                            <div class="space-y-2">
                                <div class="flex flex-col sm:flex-row gap-2">
                                    <input 
                                        ...
                                        required 
                                        maxlength="255"
                                        class="flex-1 px-3 py-2 border-2 border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors duration-200 font-nunito text-sm"
                        ...
                        <div id="verification-section" class="hidden space-y-1">
                            ...
                            <div class="flex gap-2">
                                <input 
                                    ...
                                    type="text" 
                                    maxlength="6"
                                    class="flex-1 px-3 py-2 border-2 border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 transition-colors duration-200 text-center text-sm tracking-widest font-nunito"
                                    placeholder="000000"
                                >
                                <button 
                                    type="button" 
                ...
                <div class="pt-1 border-t border-gray-700">
                    <div class="bg-blue-900/20 rounded-lg p-4 text-center">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2 font-nunito">¿Tu cuenta pertenece a una empresa?</h3>
                        <p class="text-base text-gray-400 mb-3 font-nunito">
                            Si representas a una empresa, puedes completar los datos corporativos como nombre comercial, RTN y logo empresarial.
                                ...
                                <a href="{{ route('cliente.configurar-empresa') }}" 
                                    class="inline-flex items-center px-4 py-2 bg-gray-800 border border-blue-600 rounded-md text-blue-300 font-medium hover:bg-blue-900/30 transition-colors duration-200 text-sm font-nunito">
