...
<div class="max-w-7xl mx-auto space-y-8 mt-16" x-data="ordenesCliente()">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-800">
                            ...
                            <td
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    <a :href="'/cliente/detalle-orden?orden=' + o.id" target="_blank" rel="noopener" data-no-spa
                                    ...
                                    <button @click="calificarOrden(o)" x-show="['cerrada','finalizada'].includes(String(o.estado||'').toLowerCase())"
    ...
    <div x-show="showRateModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md p-5">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Selecciona una calificación para la orden <span x-text="selected?.numero || ''"></span>.</p>
            <div class="grid grid-cols-2 gap-2 mb-4 text-sm">
                <label class="flex items-center gap-2 px-3 py-2 rounded border cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <div class="flex justify-end gap-2">
                ...
                <button @click="submitRate()" :disabled="!rateValue" class="px-3 py-1.5 rounded bg-emerald-600 text-white text-sm disabled:opacity-50">Confirmar</button>
            </div>
        </div>
