        ...
        <div class="flex items-center gap-1 sm:gap-2 mr-1 sm:mr-2">
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false"
                    ...
                    <x-admin.sidebar-link href="#" :active="false" view-name="perfil" @click="open = false; loadView('perfil')"
                        class="w-full text-left px-4 py-2 text-sm nunito-regular text-gray-700 hover:bg-blue-300 hover:text-gray-800 transition-colors duration-200 flex items-center gap-2">
