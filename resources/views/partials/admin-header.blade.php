            ...
            <div class="flex items-center gap-1 sm:gap-2 mr-1 sm:mr-2">
                <div x-data="{ open: false, logoutConfirm: false }" class="relative"
                    ...
                    <div x-show="open" x-cloak @click.away="open = false" @header-link-click="open = false"
                        ...
                        <button @click="logoutConfirm = true; open = false" 
                                class="w-full flex items-center gap-2 px-3 py-1.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-100 dark:hover:bg-blue-700/50 transition-colors text-left">
